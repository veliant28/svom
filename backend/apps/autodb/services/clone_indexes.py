...
class AutoDbCloneIndexService:
    ...
    VEHICLE_INDEX_TARGETS: tuple[IndexTarget, ...] = (
        ...
        IndexTarget("commercial_vehicles", ("id",)),
        IndexTarget("commercial_vehicles", ("modelid",)),
        IndexTarget("commercial_vehicles", ("constructioninterval",)),
        IndexTarget("commercial_vehicles", ("description",)),
        IndexTarget("commercial_vehicles", ("fulldescription",)),
        IndexTarget("engines", ("id",)),
        IndexTarget("axles", ("id",)),
        IndexTarget("motorbikes", ("id",)),
        IndexTarget("motorbikes", ("modelid",)),
        IndexTarget("passanger_car_engines", ("passangercarid",)),
        IndexTarget("passanger_car_engines", ("engineid",)),
        IndexTarget("commercial_vehicle_engines", ("commercialvehicleid",)),
        IndexTarget("commercial_vehicle_engines", ("engineid",)),
        ...
        IndexTarget("commercial_vehicle_attributes", ("commercialvehicleid",)),
        IndexTarget("commercial_vehicle_attributes", ("attributetype",)),
        IndexTarget("commercial_vehicle_attributes", ("displaytitle",)),
        IndexTarget("prd", ("id",)),
        ...
        IndexTarget("commercial_vehicle_trees", ("commercialvehicleid",)),
        IndexTarget("commercial_vehicle_trees", ("searchtreeid",)),
        IndexTarget("commercial_vehicle_trees", ("parentid",)),
        IndexTarget("commercial_vehicle_trees", ("id",)),
    )
