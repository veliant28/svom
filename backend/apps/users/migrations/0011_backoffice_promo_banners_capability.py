...
CAPABILITY = (
    ...
    "bo_cap_promo_banners_manage",
    "Promo banners manage",
)


def add_promo_banners_capability(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("users", "0010_backoffice_footer_settings_capability"),
        ("auth", "0012_alter_user_first_name_max_length"),
        ("contenttypes", "0002_remove_content_type_name"),
    ]

    operations = [
        migrations.RunPython(add_promo_banners_capability, noop_reverse),
    ]
