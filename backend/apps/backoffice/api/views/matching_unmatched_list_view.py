...
from apps.backoffice.selectors.imports_selectors import apply_import_raw_offer_filters, get_unmatched_raw_offers_queryset


class MatchingUnmatchedListAPIView(ListAPIView):
    ...
    def get_queryset(self):
        queryset = get_unmatched_raw_offers_queryset()
