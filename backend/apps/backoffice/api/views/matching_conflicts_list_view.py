...
from apps.backoffice.selectors.imports_selectors import apply_import_raw_offer_filters, get_conflict_raw_offers_queryset


class MatchingConflictsListAPIView(ListAPIView):
    ...
    def get_queryset(self):
        queryset = get_conflict_raw_offers_queryset()
