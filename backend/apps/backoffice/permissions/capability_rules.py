...
RULES: tuple[BackofficeCapabilityRule, ...] = (
    ...
    BackofficeCapabilityRule("settings/email/", ("email.settings",), ("email.settings",)),
    ...
    BackofficeCapabilityRule("database-backup/", ("schedules.view",), ("schedules.view",)),
    ...
    BackofficeCapabilityRule("workers/", ("workers.manage",), ("workers.manage",)),
