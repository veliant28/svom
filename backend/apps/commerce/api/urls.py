...
urlpatterns = [
    ...
    path("checkout/methods/", CheckoutMethodsAPIView.as_view(), name="checkout-methods"),
    ...
    path("returns/", ReturnRequestListAPIView.as_view(), name="returns-list"),
    path("returns/create/", ReturnRequestCreateAPIView.as_view(), name="returns-create"),
    path("returns/eligible-orders/", EligibleReturnOrdersAPIView.as_view(), name="returns-eligible-orders"),
    path("returns/eligible-orders/<uuid:order_id>/", EligibleReturnOrderDetailAPIView.as_view(), name="returns-eligible-order-detail"),
    path("returns/<uuid:id>/", ReturnRequestDetailAPIView.as_view(), name="returns-detail"),
    path("returns/<uuid:id>/tracking/", ReturnRequestTrackingSubmitAPIView.as_view(), name="returns-tracking-submit"),
    path("account/orders/<uuid:order_id>/receipt/open/", AccountOrderReceiptOpenAPIView.as_view(), name="account-order-receipt-open"),
    path("loyalty/my-codes/", LoyaltyMyPromoCodesAPIView.as_view(), name="loyalty-my-codes"),
    path("support/bootstrap/", SupportBootstrapAPIView.as_view(), name="support-bootstrap"),
    path("support/threads/", SupportThreadListCreateAPIView.as_view(), name="support-thread-list-create"),
    path("support/threads/<uuid:id>/", SupportThreadDetailAPIView.as_view(), name="support-thread-detail"),
    path("support/threads/<uuid:id>/messages/", SupportThreadMessagesAPIView.as_view(), name="support-thread-messages"),
    path("support/threads/<uuid:id>/read/", SupportThreadReadAPIView.as_view(), name="support-thread-read"),
]
