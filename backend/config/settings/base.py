...
UTR_LAZY_CATALOG_APPLICABILITY_ENABLED = env_bool("UTR_LAZY_CATALOG_APPLICABILITY_ENABLED", True)
UTR_LAZY_CATALOG_APPLICABILITY_TOP_N = max(env_int("UTR_LAZY_CATALOG_APPLICABILITY_TOP_N", 12), 0)
UTR_LAZY_APPLICABILITY_QUEUE_LOCK_SECONDS = max(env_int("UTR_LAZY_APPLICABILITY_QUEUE_LOCK_SECONDS", 30 * 60), 60)
UTR_LAZY_ENRICH_CHARACTERISTICS_ENABLED = env_bool("UTR_LAZY_ENRICH_CHARACTERISTICS_ENABLED", True)
