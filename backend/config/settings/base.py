...
SUPPLIER_IMPORT_PIPELINE_LOCK_SECONDS = max(
    env_int("SUPPLIER_IMPORT_PIPELINE_LOCK_SECONDS", SUPPLIER_IMPORT_SCHEDULED_PIPELINE_TIME_LIMIT),
    60,
)
...
GPL_API_PER_PAGE_MAX = max(env_int("GPL_API_PER_PAGE_MAX", 1000), 1)
GPL_API_PER_PAGE = max(env_int("GPL_API_PER_PAGE", 1000), 1)
GPL_API_PAGE_DELAY_SECONDS = max(env_float("GPL_API_PAGE_DELAY_SECONDS", 3.0), 0.0)
GPL_API_PAGE_RETRY_ATTEMPTS = max(env_int("GPL_API_PAGE_RETRY_ATTEMPTS", 4), 1)
...
AUTODB_PRO_REMOTE_SKIP_TOTAL_COUNT = env_bool("AUTODB_PRO_REMOTE_SKIP_TOTAL_COUNT", False)
...
BACKOFFICE_WORKER_HISTORY_LIMIT = max(env_int("BACKOFFICE_WORKER_HISTORY_LIMIT", 240), 30)
BACKOFFICE_WORKER_OFFLINE_TTL_SECONDS = max(env_int("BACKOFFICE_WORKER_OFFLINE_TTL_SECONDS", 60 * 30), 120)
BACKOFFICE_WORKER_STUCK_RUNTIME_SECONDS = max(env_int("BACKOFFICE_WORKER_STUCK_RUNTIME_SECONDS", 60 * 15), 60)
BACKOFFICE_WORKER_STUCK_NO_PROGRESS_SECONDS = max(env_int("BACKOFFICE_WORKER_STUCK_NO_PROGRESS_SECONDS", 60 * 4), 60)
BACKOFFICE_WORKER_STUCK_LOW_CPU_THRESHOLD = max(env_float("BACKOFFICE_WORKER_STUCK_LOW_CPU_THRESHOLD", 0.6), 0.0)
