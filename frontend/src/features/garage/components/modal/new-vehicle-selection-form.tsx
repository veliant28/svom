...
import { isAutoDbVehicleCatalogEnabled } from "@/features/garage/config/vehicle-catalog";
...
export function NewVehicleSelectionForm(props: NewVehicleSelectionFormProps) {
  if (isAutoDbVehicleCatalogEnabled) {
    return (
      <AutoDbSelectionForm
  ...
  return (
    <LegacySelectionForm
      isAuthenticated={props.isAuthenticated}
      onUseTemporary={props.onUseTemporary}
      onSaveVehicle={props.onSaveVehicle}
    />
  );
}
