...
import { SupportPage } from "@/features/backoffice/pages/support-page";
import { ensureBackofficeRouteCapability } from "@/features/backoffice/server/ensure-backoffice-route-capability";

export default async function BackofficeSupportRoute({ params }: { params: Promise<{ locale: string }> }) {
