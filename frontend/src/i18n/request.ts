...
const localeModuleLoaders: Record<AppLocale, LocaleModuleLoaders> = {
  en: {
    ...
    backofficeCommon: [
      ...
      () => import("../messages/en/backoffice/common-integration-center.json").then((module) => module.default as Messages),
  ...
  ru: {
    ...
    backofficeCommon: [
      ...
      () => import("../messages/ru/backoffice/common-integration-center.json").then((module) => module.default as Messages),
  ...
  uk: {
    ...
    backofficeCommon: [
      ...
      () => import("../messages/uk/backoffice/common-integration-center.json").then((module) => module.default as Messages),
